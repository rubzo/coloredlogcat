...
# These modifications by stephen kyle
# - accepts the F/libc messages generated by segfaults that
#   otherwise cause coloredlogcat to stop reading.
# - arguments given to this script are assumed to be for logcat, not adb.
...
TAGTYPES = {
    ...
    "F": "%s%s%s " % (format(fg=BLACK, bg=MAGENTA), "F".center(TAGTYPE_WIDTH), format(reset=True)),
}
